...
general_cfg = EasyDict({
    ...
    'training': {
        'exp_description': 'centernet_event_v8n_finetune_all_from_exp_40',
        'mask_ball_prob': 0.15,
        'prev_ckpt_path': 'ckpt/exp44_centernet_event_v8n_finetune_all_from_exp_40/model-epoch=67-train_loss=0.484-val_loss=0.494-val_acc=0.996-val_ev_acc=0.404-val_rmse=5.744.ckpt',
        'base_lr': 0.001,
        'bs': 8,
        'max_epoch': 100,
        'min_epoch': 30,
