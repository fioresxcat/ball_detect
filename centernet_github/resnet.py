...
class ResNet(nn.Module):
    def __init__(self, in_c, slug='r50', pretrained=True):
        super().__init__()
        if not pretrained:
        ...
        if slug == 'r18':
            ...
            self.resnet = models.resnext50_32x4d(weights=models.ResNeXt50_32X4D_Weights.DEFAULT)
            num_bottleneck_filters = 2048
        elif slug == 'rx101':
        ...
        self.resnet.conv1 = nn.Conv2d(in_channels=in_c, out_channels=64, kernel_size=7, stride=2, padding=3, bias=False)
